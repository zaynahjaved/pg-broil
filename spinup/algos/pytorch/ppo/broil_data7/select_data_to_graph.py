...
for lambda_val in lambda_val_arr:
    for pi_lr in pi_lr_arr:
        for vf_lr in vf_lr_arr:
            ...
            plot_comparison = [(0.0, lambda_val, pi_lr, vf_lr), (0.2, lambda_val, pi_lr, vf_lr), (0.4, lambda_val, pi_lr, vf_lr), (0.6, lambda_val, pi_lr, vf_lr), (0.8, lambda_val, pi_lr, vf_lr)]
            metric = 'worst_case_return'
            metric = metric.lower()
            ...
            plt.legend()
            #plt.show()
            plt.savefig('worst_graphs/' + 'lambda_' + str(lambda_val) + '_policy_' + str(pi_lr) + '_value_' + str(vf_lr) + '.png')
