...
lambda_val_arr = [0, 0.04, 0.08, 0.12, 0.16, 0.2, 0.24]
pi_lr_arr = [1e-3, 1e-2, 1e-1]
vf_lr_arr = [1e-3, 1e-2, 1e-1]

for lambda_val in lambda_val_arr:
    for pi_lr in pi_lr_arr:
        for vf_lr in vf_lr_arr:
            plot_comparison = [(0.9, lambda_val, pi_lr, vf_lr), (0.92, lambda_val, pi_lr, vf_lr), (0.95, lambda_val, pi_lr, vf_lr), (0.97, lambda_val, pi_lr, vf_lr), (0.99, lambda_val, pi_lr, vf_lr)]
            metric = 'cvar'
            metric = metric.lower()
